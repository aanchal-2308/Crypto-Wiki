...
export default class CoinData extends Component
{
    ...
    componentDidMount()
    {        //sample function to check the coin data
            ...
            <div className="row result text-center">
                <div className="col-xl-2 col-lg-2 col-md-2 result-table">
                   <table border="1px" >
                       <tbody>
                     <tr>
                       <td> <img src={this.props.dataobj.data.image.large} alt="Coin-Thumb" height="150px" width="150px" />
                       </td>
                ...
                <div className="col-xl-10 col-lg-10 col-md-10 mt-5 ">
                    <p>
                        {this.props.dataobj.data.description.en}
                    </p>
                </div>
            </div>
            </div>
